 ...
 */
class getWordsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WordsRepository' shared autowired service.
     *
     * @return \App\Repository\WordsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WordsRepository.php';

        return $container->privates['App\\Repository\\WordsRepository'] = new \App\Repository\WordsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
