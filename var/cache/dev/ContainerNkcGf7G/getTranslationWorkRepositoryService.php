 ...
 */
class getTranslationWorkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TranslationWorkRepository' shared autowired service.
     *
     * @return \App\Repository\TranslationWorkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TranslationWorkRepository.php';

        return $container->privates['App\\Repository\\TranslationWorkRepository'] = new \App\Repository\TranslationWorkRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
